	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/bbaddiction.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/bbaddiction.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/bbaddiction.css',
				dest: '_gh_pages/dist/css/min/bbaddiction.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/bbaddiction.js',
				dest: '_gh_pages/dist/js/min/bbaddiction.min.js'
			}
		},
		watch: {
			css: {
